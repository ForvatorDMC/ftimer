surface.CreateFont("fchat.form", {font = "Open Sans", size = 24, weight = 400})
...
function panel:Paint(w, h)
	...
	draw.SimpleText(self.title, "fchat.form", 12, 26, color_white, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
...
vgui.Register("fchat.form", panel, "fchat.frame")
