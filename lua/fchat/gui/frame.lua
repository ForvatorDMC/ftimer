...
local closeImage = Material("fchat/cross.png", "smooth")
...
function panel:Paint(w, h)
	...
	draw.SimpleText(self.title, "fchat.theme.default.title", 12, 16, color_white, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
...
vgui.Register("fchat.frame", panel, "EditablePanel")
